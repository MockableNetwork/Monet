#
#  Be sure to run `pod spec lint Monet.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.license      = "Apache License, Versión 2.0"
  spec.license      = { :type => "Apache License, Versión 2.0", :file => "LICENSE" }
